...
MainPlot::MainPlot()
{
	...
	defaultVal.push_back("график (заголовок=\"Потребление O2 и выделение CO2\",осреднение=\"20 сек\",y=Минутное_потребление_O2&Минутное_выделение_CO2,легенда=\"VO2(л/мин.)\"&\"VCO2(л/мин.)\",начало=0.000000,конец=6.000000)");
	defaultVal.push_back("график (заголовок=\"ЧСС и О2 - пульс\",осреднение=\"20 сек\",y=ЧСС,легенда=\"ЧСС(уд./мин.)\",начало=0.000000,конец=200.000000,y=O2_ЧСС,легенда=\"O2 - Пульс(мл/уд.)\",начало=0.000000,конец=30.000000)");
	defaultVal.push_back("график (заголовок=\"VCO2 vs VO2\",осреднение=\"20 сек\",x=Минутное_выделение_CO2,легенда=\"VCO2(л/мин.)\",начало=0.000000,конец=6.000000,y=Минутное_потребление_O2,легенда=\"VO2(л/мин.)\",начало=0.000000,конец=6.000000,y=ЧСС,легенда=\"ЧСС(уд./мин.)\",начало=0.000000,конец=200.000000)");
	defaultVal.push_back("график (заголовок=\"Вентиляционные эквиваленты\",осреднение=\"20 сек\",y=Вентиляционный_эквивалент_O2&Вентиляционный_эквивалент_CO2,легенда=\"ВЭ O2\"&\"ВЭ CO2\",начало=0.000000,конец=60.000000)");
	defaultVal.push_back("график (заголовок=\"VE\",осреднение=\"20 сек\",y=Минутная_вентиляция,легенда=\"VE(л/мин.)\",начало=0.000000,конец=150.000000)");
	defaultVal.push_back("график (заголовок=\"VE vs VCO2\",осреднение=\"20 сек\",x=Минутное_выделение_CO2,легенда=\"VCO2(л/мин.)\",начало=0.000000,конец=6.000000,y=Минутная_вентиляция,легенда=\"VE(л)\",начало=0.000000,конец=150.000000)");
	defaultVal.push_back("график (заголовок=\"FetO2 и FetCO2\",осреднение=\"20 сек\",y=FetO2,легенда=\"FetO2(%)\",начало=0.000000,конец=20.000000,y=FetCO2,легенда=\"FetCO2(%)\",начало=0.000000,конец=10.000000)");
	defaultVal.push_back("график (заголовок=\"Дыхательный коэффициент\",осреднение=\"20 сек\",y=Дыхательный_коэффициент,легенда=\"ДК\",начало=0.600000,конец=1.600000)");
	defaultVal.push_back("график (заголовок=\"VT vs VE\",осреднение=\"20 сек\",x=Минутная_вентиляция,легенда=\"VE(л/мин.)\",начало=0.000000,конец=150.000000,y=Vвдоха,легенда=\"VT(л)\",начало=0.000000,конец=5.000000)");
...
void MainPlot::LoadPlotFromConfig(Plot& plot) //PLOT_LIST on TABLE screen
{
	...
	int w = Width / 3;
	int h = Height / 3;
	string out = ini.Read("Plots", "plot_list", "plot(осреднение=\"1 сек\",y=\"ДК\",начало=0.600000,конец=1.600000)");
	try {
