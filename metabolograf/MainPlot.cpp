...
MainPlot::MainPlot()
{
	...
	defaultVal.push_back("график (заголовок=\"Вентиляционные эквиваленты\",осреднение=\"20 сек\",y=Вентиляционный_эквивалент_O2&Вентиляционный_эквивалент_CO2,легенда=\"Вент.эквивалент по O2\"&\"Вент.эквивалент по CO2\",начало=0.000000,конец=60.000000)");
	...
	defaultVal.push_back("график (заголовок=\"Дыхательный коэффициент\",осреднение=\"20 сек\",y=Дыхательный_коэффициент,легенда=\"Дыхательный коэффициент\",начало=0.600000,конец=1.600000)");
